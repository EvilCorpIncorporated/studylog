...
export async function addTabToLocalStore(tab: TabEvent): Promise<void> {
  // TODO: change name - input argument is not a tab
...
export async function getUserId() {
  await initializeUserIdSingleton(); // TODO: this is a hack, fix it - this is a hack to ensure that the userId is initialized
...
export async function clearIdleEventsState() {
  // TODO: duplicate code
  const defaults: Partial<StorageData> = {
    idleEvents: [],
  };
