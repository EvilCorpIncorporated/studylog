...
export declare type $Object_0db9a7687ccc11ed9ee685408c9df36cλShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
declare type $Object_0db9a7687ccc11ed9ee685408c9df36c = $.ObjectType<"schema::Object", $Object_0db9a7687ccc11ed9ee685408c9df36cλShape, null, [
  ..._std.$BaseObject['__exclusives__'],
]>;
declare const $Object_0db9a7687ccc11ed9ee685408c9df36c: $Object_0db9a7687ccc11ed9ee685408c9df36c

declare const Object_0db9a7687ccc11ed9ee685408c9df36c: $.$expr_PathNode<$.TypeSet<$Object_0db9a7687ccc11ed9ee685408c9df36c, $.Cardinality.Many>, null> 

export declare type $SubclassableObjectλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
declare type $SubclassableObject = $.ObjectType<"schema::SubclassableObject", $SubclassableObjectλShape, null, [
  ...$Object_0db9a7687ccc11ed9ee685408c9df36c['__exclusives__'],
]>;
...
export declare type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export declare type $DeltaλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $FutureBehaviorλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
}>;
...
export declare type $SourceλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
...
export declare type $ModuleλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & $AnnotationSubjectλShape & {
}>;
...
export declare type $ObjectTypeλShape = $.typeutil.flatten<$InheritingObjectλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $AnnotationSubjectλShape & Omit<$TypeλShape, "<target"> & $SourceλShape & {
  ...
  "<__type__[is std::Object]": $.LinkDesc<_std.$Object_0d79ae1a7ccc11edbb9609e32e1f36ef, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is std::FreeObject]": $.LinkDesc<_std.$FreeObject, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is schema::Object]": $.LinkDesc<$Object_0db9a7687ccc11ed9ee685408c9df36c, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is Tab]": $.LinkDesc<_default.$Tab, $.Cardinality.Many, {}, false, false,  false, false>;
...
export declare type $ParameterλShape = $.typeutil.flatten<$Object_0db9a7687ccc11ed9ee685408c9df36cλShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
...
declare type __defaultExports = {
  ...
  "Object": typeof Object_0db9a7687ccc11ed9ee685408c9df36c;
