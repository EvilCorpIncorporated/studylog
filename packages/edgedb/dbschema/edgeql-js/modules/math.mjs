...
function abs(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "09d62586-7ccc-11ed-b300-175d062a065f", optional: false, setoftype: false, variadic: false}], returnTypeId: "09d62586-7ccc-11ed-b300-175d062a065f"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function var_11083eb67ccc11ed857f6d4bda876e73(...args) {
...
const __defaultExports = {
  ...
  "var": var_11083eb67ccc11ed857f6d4bda876e73,
  "var_pop": var_pop
};
