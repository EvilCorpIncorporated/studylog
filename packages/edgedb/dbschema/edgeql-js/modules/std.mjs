...
const JsonEmpty = $.makeType(_.spec, "0caeb430-7ccc-11ed-9d05-8b4e9c0becd4", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "09d9ead6-7ccc-11ed-977f-e9bc9326e423", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "0d76d14a-7ccc-11ed-92ef-5369d9e087b7", _.syntax.literal);

const BaseObject= _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null);

const $Object_0d79ae1a7ccc11edbb9609e32e1f36ef = $.makeType(_.spec, "0d79ae1a-7ccc-11ed-bb96-09e32e1f36ef", _.syntax.literal);

const Object_0d79ae1a7ccc11edbb9609e32e1f36ef= _.syntax.$PathNode($.$toSet($Object_0d79ae1a7ccc11edbb9609e32e1f36ef, $.Cardinality.Many), null);

const $FreeObject = $.makeType(_.spec, "0d7d27d4-7ccc-11ed-9d17-6d01a840b10a", _.syntax.literal);
...
function min(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "09d62586-7ccc-11ed-b300-175d062a065f", optional: false, setoftype: true, variadic: false}], returnTypeId: "09d62586-7ccc-11ed-b300-175d062a065f", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "09da45da-7ccc-11ed-b870-0985f3a158db", optional: false, setoftype: true, variadic: false}], returnTypeId: "09da45da-7ccc-11ed-b870-0985f3a158db", returnTypemod: "OptionalType", preservesOptionality: true},
...
function contains(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::contains', args, _.spec, [
    ...
    {args: [{typeId: "766e546b-5ee0-d891-f2ef-f09139c3f45e", optional: false, setoftype: false, variadic: false}, {typeId: "766e546b-5ee0-d891-f2ef-f09139c3f45e", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
    {args: [{typeId: "766e546b-5ee0-d891-f2ef-f09139c3f45e", optional: false, setoftype: false, variadic: false}, {typeId: "09d2d426-7ccc-11ed-af6c-035dc648658f", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
...
function range_is_empty(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
    {args: [{typeId: "766e546b-5ee0-d891-f2ef-f09139c3f45e", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function range_get_upper(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
    {args: [{typeId: "766e546b-5ee0-d891-f2ef-f09139c3f45e", optional: false, setoftype: false, variadic: false}], returnTypeId: "09d2d426-7ccc-11ed-af6c-035dc648658f", returnTypemod: "OptionalType"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function sequence_reset(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "0f2da8ce-7ccc-11ed-af81-7beb55830106", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "0f2da8ce-7ccc-11ed-af81-7beb55830106", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_0d79ae1a7ccc11edbb9609e32e1f36ef, Object_0d79ae1a7ccc11edbb9609e32e1f36ef, $FreeObject, FreeObject };
...
const __defaultExports = {
  ...
  "Object": Object_0d79ae1a7ccc11edbb9609e32e1f36ef,
